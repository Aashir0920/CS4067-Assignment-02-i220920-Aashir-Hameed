  ...
  return (
    <div className="app-container">
      <header className="header">
        ...
        <button onClick={() => setShowAddEvent(true)} style={{ padding: '10px', backgroundColor: '#4CAF50', color: 'black', marginRight: '10px' }}>Add Event</button>
        <button onClick={fetchBookings} style={{ padding: '10px', backgroundColor: '#3498db', color: 'black' }}>Show My Bookings</button>
      </header>
